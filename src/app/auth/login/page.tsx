...
export default function LoginPage() {
  ...
  const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!form.identifier.trim()) newErrors.identifier = "ID atau email wajib diisi.";
            ...
            <div className="mt-10 space-y-4">
              <div className="flex items-start gap-3 rounded-2xl border border-white/70 bg-white/70 p-4 backdrop-blur-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Sistem login aman untuk mengelola akun dan data penting.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 rounded-2xl border border-white/70 bg-white/70 p-4 backdrop-blur-sm">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">
                    Pantau kondisi dan performa sistem secara langsung.
                  </p>
                </div>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  className="w-full rounded-xl border border-gray-200 bg-white px-4 py-3 text-sm outline-none transition focus:border-green-700 focus:ring-4 focus:ring-green-100"
                />
                {errors.identifier && (
                  <p className="mt-2 text-sm text-red-500">{errors.identifier}</p>
                )}
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-xl border border-gray-200 bg-white px-4 py-3 pr-12 text-sm outline-none transition focus:border-green-700 focus:ring-4 focus:ring-green-100"
                  />
              ...
              <div className="flex items-center justify-between gap-4 text-sm">
                ...
                <button type="button" className="font-medium text-gray-500 transition hover:text-green-700">
                  Forgot password?
                </button>
              </div>
              ...
              <button
                type="submit"
                className="w-full rounded-xl bg-green-800 px-4 py-3 text-sm font-semibold text-white shadow-sm transition hover:bg-green-900 focus:outline-none focus:ring-4 focus:ring-green-200"
              >
                Masuk
              </button>
            </form>
